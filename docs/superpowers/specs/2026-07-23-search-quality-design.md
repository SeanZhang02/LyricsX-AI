...
- **白名单去括号**(不是删所有括号,保护 "(I Can't Get No) Satisfaction" 这类):括号类 `()[]（）【】`,组内文本(小写 trim)以噪声词**开头**才删——`feat/ft/featuring/with/prod/remaster/deluxe/anniversary/edition/version/ver./radio edit/single/album/bonus/live/acoustic/unplugged/demo/mono/stereo/explicit/clean/remix/cover/instrumental/karaoke/off vocal/伴奏/现场/翻自/from `。
